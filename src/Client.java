...
public class Client {
  ...
  public static void main(String[] args) throws IOException {
    ...
    List<String> commands = Arrays.asList(":list_rooms", ":create_room", ":join_room", ":exit_room", ":list_members", ":list_users", ":exit -> Leave server");
    String menuOption;
            ...
            case ":join_room":
              ...
              while (chatting) {
                ...
                if (userInput.startsWith(":exit_room")) {
                  ...
                  System.out.println(fromServer.readUTF());
                  chatting = false;
                } else if (userInput.startsWith(":list_members")) {
                  toServer.writeUTF(userInput);
                  System.out.println(fromServer.readUTF());
                } else {
